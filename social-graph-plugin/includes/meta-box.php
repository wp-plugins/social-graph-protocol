...
<table cellpadding="4" cellspacing="8">
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'General Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'Location Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'Personal/Business Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'Video Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'Audio Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td colspan="2">
			<p style="font-weight:bold;font-size:14px;"><?php _e( 'Product Settings', 'social-graph-protocol' ); ?></p>
		</td>
	</tr>
	<tr>
		<td>
