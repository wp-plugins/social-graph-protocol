		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					...
					<td>
						<input id="description" name="sgp_settings[description]" type="text" class="regular-text" value="<?php echo $options['description']; ?>" maxlength="150" />
				...
				<tr valign="top">
					...
					<td>
						<input id="image" name="sgp_settings[image]" type="text" class="regular-text" value="<?php echo $options['image']; ?>" />
				...
				<tr valign="top">
					...
					<td>
						<input id="fbuids" name="sgp_settings[fbuids]" type="text" class="regular-text" value="<?php echo $options['fbuids']; ?>" />
					...
					<td>
						<fieldset>
							<label for="namespaces">
								<input id="namespaces" name="sgp_settings[namespaces]" type="checkbox" value="1"<?php checked( 1, $options['namespaces'] ); ?> />
