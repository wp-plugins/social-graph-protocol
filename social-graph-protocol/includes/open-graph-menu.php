...
<div class="wrap">
	...
	<form style="margin-top: 12px;" action="<?php echo $_SERVER['PHP_SELF'] . "?" . $_SERVER['QUERY_STRING']; ?>" method="POST">
		<div id="facebook-open-graph">
			...
			<div class="row">
				<div class="column-one">
					<label for="custom_post_types">Custom Post Types: </label>
				</div>
				<div class="column-two">
					<input name="custom_post_types" id="custom_post_types" type="text" size="40" value="<?php echo $custom_post_types; ?>" />
				</div>
				<div class="column-three">
					<span>A comma seperated list of any custom post type slugs you intend to use on the open graph.</span>
				</div>
			</div>
