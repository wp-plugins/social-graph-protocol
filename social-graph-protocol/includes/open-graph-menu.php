			...
			<div class="row">
				...
				<div class="column-two">
					<select name="og_type" id="og_type">
						<option value="blog"<?php if( $type == 'blog' ) echo ' selected="true"'; ?>><?php _e( 'Blog', 'social-graph-protocol' ); ?></option>
						<option value="website"<?php if( $type == 'website' ) echo ' selected="true"'; ?>><?php _e( 'Website', 'social-graph-protocol' ); ?></option>
					</select>
				</div>
				<div class="column-three">
					<span><?php _e( 'If all you do is blog simply select blog, if you think you have a more traditional website, select website.', 'social-graph-protocol' ); ?></span>
				</div>
			</div>
