...
Tested up to: 3.5-RC2-22958
Stable tag: 1.2.2/social-graph-protocol
...
Please refer to the post [Social Graph Protocol Plugin For Wordpress](http://www.codehooks.com/social-graph-protocol-plugin-for-wordpress/ "Social Graph Protocol Plugin For Wordpress") on the [CodeHooks](http://www.codehooks.com/ "CodeHooks") website. 
...
= 1.2.2 =
* Removed the duplication of og meta tags when using this plugin along side the WP Facebook plugin (http://wordpress.org/extend/plugins/facebook/)
